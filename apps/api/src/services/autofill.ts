...
const DIRECT_COPY: Partial<Record<CanonicalField, (p: MasterProfile) => string>> = {
  ...
  // Date-range widgets (education/work period year+month selects) are
  // CLASSIFIED but deliberately given no value: the live PwC run drove them
  // wrong, and the user chose "empty over wrong or slow" (2026-08-12). The
  // canonicals stay so the fields are recognized and honestly skipped.
